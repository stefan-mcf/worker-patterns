...
from .adapter import adapt_to_hermes
from .policy import (
    BASE_PATTERNS,
    CLOSE_SCORE_MARGIN,
    ...
    if base == WorkerPattern.MODULE_SWARM:
        ...
        for scope in scopes:
            lanes.append(
                PatternLane(
                    ...
                    hermes_hint=f"wave-limited {scale.profile_pool_strategy}; max active builders {scale.max_active_lanes}",
        ...
        lanes.append(
            PatternLane(
                ...
                hermes_hint="main Hermes turn or /goal continuation",
        ...
        for i in range(count):
            ...
            lanes.append(
                PatternLane(
                    ...
                    hermes_hint="delegate_task batch",
        ...
        for dep in deps:
            ...
            lanes.append(
                PatternLane(
                    ...
                    hermes_hint="Kanban child task or /goal step",
        ...
        lanes.append(
            PatternLane(
                ...
                hermes_hint="single strong Hermes worker/profile",
        ...
        lanes.append(
            PatternLane(
                ...
                hermes_hint="direct Hermes turn or /goal",
    ...
    if WorkerPattern.TWIN_INSPECTION in overlays:
        ...
        lanes.append(
            PatternLane(
                ...
                hermes_hint="delegate_task reviewer or swarm review profile",
...
def _safety_notes(request: PatternRequest) -> tuple[str, ...]:
    notes = ["Hermes executes; this package only selects/adapts worker patterns."]
    blob = _blob(request)
...
def select_worker_pattern(request: PatternRequest) -> PatternPlan:
    ...
    return PatternPlan(
        ...
        selection=selection,
        lanes=lanes,
        hermes_mapping=adapt_to_hermes(request, selection, lanes),
